...
function NxKeyE2ESample(){
    ...
    return (
        <>
            <LinkComponent/>
            <h1>NxKeyE2ESample</h1>
            <NxKeyEdit type="text" id="userid" name="userid" placeholder="사용자 아이디"/><br/>
            <NxKeyEdit type="password" id="userpw" name="userpw" enc="on" placeholder="사용자 비밀번호"/><br/>
            <NxKeyEdit type="password" id="usernum" name="usernum" datatype="n" maxlength="4" enc="on"  placeholder="카드번호 4자리 입력 ( 숫자만 )"/><br/>
