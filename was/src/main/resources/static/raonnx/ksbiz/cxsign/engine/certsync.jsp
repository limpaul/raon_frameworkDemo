...
<%
	...
	//CertSyncTool.ENTRY_REMOVE_TIMEOUT = 1000 * 60 * 10; //10분
	...
	//메모리 저장방식. 여러 서버가 서로 공유하는 환경. 
	//서버는 100대를 넘을 수 없음.
	//모든 서버가 반드시 배열의 순서를 똑같이 맞춰야 함
	//10대 이하인 경우 인증번호 첫자리가 서버인덱스, 10대를 넘는경우 두자리가 서버 인덱스가 된다.
	/*
