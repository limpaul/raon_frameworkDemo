/* /websquare_git/websquare/_websquare_/uiplugin/grid/upload/advancedfileUpload.xml 20210416.093307 45649 6df7d864e992d73e807a18b2f6750c1c5b5ddd4173200ac7d311deb42d0b6817 */
export default {
    declaration: {
        A: {
            version: '1.0',
            ...
            E: [{
                ...
                E: [{
                    ...
                    cdata: function(scopeObj) {
                        ...
                        var bg_header = scopeObj["bg_header"];
                        var advancedSetting = scopeObj["advancedSetting"];
                        var setting = scopeObj["setting"];
                        var subcheck = scopeObj["subcheck"];
                        var bul_title = scopeObj["bul_title"];
                        var filename = scopeObj["filename"];
                        var sub = scopeObj["sub"];
                        var advanced = scopeObj["advanced"];
                        var space_option = scopeObj["space_option"];
                        var spaceSelect = scopeObj["spaceSelect"];
                        var start_option = scopeObj["start_option"];
                        var gridStartRow = scopeObj["gridStartRow"];
                        var hidden_option = scopeObj["hidden_option"];
                        var hiddenSelect = scopeObj["hiddenSelect"];
                        var start_col = scopeObj["start_col"];
                        var gridStartCol = scopeObj["gridStartCol"];
                        var hidden_fill = scopeObj["hidden_fill"];
                        var fillHidden = scopeObj["fillHidden"];
                        var sheet_no = scopeObj["sheet_no"];
                        var gridSheetNo = scopeObj["gridSheetNo"];
                        var isHeader = scopeObj["isHeader"];
                        var header = scopeObj["header"];
                        var isFooter = scopeObj["isFooter"];
                        var footer = scopeObj["footer"];
                        var isPwd = scopeObj["isPwd"];
                        var pwd = scopeObj["pwd"];
                        var sendFILE = scopeObj["sendFILE"];
                        var domain = scopeObj["domain"];
                        var columnNum = scopeObj["columnNum"];
                        var hiddenColumns = scopeObj["hiddenColumns"];
                        var removeColumns = scopeObj["removeColumns"];
                        var headerRows = scopeObj["headerRows"];
                        var bodyRows = scopeObj["bodyRows"];
                        var delim = scopeObj["delim"];
                        var expressionColumns = scopeObj["expressionColumns"];
                        var gridStyle = scopeObj["gridStyle"];
                        var insertColumns = scopeObj["insertColumns"];
                        var gridEndCol = scopeObj["gridEndCol"];
                        var loadingMode = scopeObj["loadingMode"];
                        var optionParam = scopeObj["optionParam"];
                        var cellDataConvertor = scopeObj["cellDataConvertor"];
                        var decimal = scopeObj["decimal"];
                        var useMaxByteLength = scopeObj["useMaxByteLength"];
                        var dateFormat = scopeObj["dateFormat"];
                        var byteCheckEncoding = scopeObj["byteCheckEncoding"];
                        var columnOrder = scopeObj["columnOrder"];
                        var gridSheetName = scopeObj["gridSheetName"];
                        var chunkNum = scopeObj["chunkNum"];
 ...
 제한 크기 : %1 byte";
            ...
            E: [{
                ...
                E: [{
                        ...
                        E: [{
                            ...
                            E: [{
                                ...
                                A: {
                                    ...
                                    ref: '',
                                    class: 'subcheck',
                                    'ev:oncheckboxclick': 'scwin.subcheck_oncheckboxclick',
                                    tagname: '',
                                    renderType: 'native'
                                },
                                E: [{
                        ...
                        E: [{
                            ...
                            E: [{
                                ...
                                A: {
                                    ...
                                    style: '',
                                    class: 'btn_exup_file',
                                    'ev:onclick': 'scwin.sendFILE_onclick'
                                },
                                E: [{
                                    T: 1,
                                    N: 'xf:label',
                    ...
                    A: {
                        adjustMaxLength: 'false',
                        name: 'expressionColumns',
                        id: 'expressionColumns',
                        style: '',
                        type: 'hidden',
                        initValue: 'CC'
                    }
                    ...
                    A: {
                        adjustMaxLength: 'false',
                        name: 'cellDataConvertor',
                        id: 'cellDataConvertor',
                        style: '',
                        type: 'hidden'
                    }
                }, {
                    ...
                    A: {
                        adjustMaxLength: 'false',
                        name: 'byteCheckEncoding',
                        id: 'byteCheckEncoding',
                        style: '',
                        type: 'hidden'
                    }
                }, {
