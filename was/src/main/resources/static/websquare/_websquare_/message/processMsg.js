/* /websquare_git/websquare/_websquare_/message/processMsg.xml 20210416.093306 4241 99c9ff3a9ce4710cae2a97f53060758fe2e9395956a5d3631a45af8aba38727f */
export default {
    declaration: {
        A: {
            version: '1.0',
        ...
        E: [{
            ...
            E: [{
                ...
                E: [{
                    ...
                    cdata: function(scopeObj) {
                        ...
                        var group_wrapper = scopeObj["group_wrapper"];
                        var text_msg = scopeObj["text_msg"];
                        var image_bar = scopeObj["image_bar"];
                        var btn_hide = scopeObj["btn_hide"];
                        var btn_cancel = scopeObj["btn_cancel"];
            ...
            E: [{
                ...
                E: [{
                    ...
                    A: {
                        type: 'button',
                        class: 'w2_proc_btn_hide',
                        id: 'btn_hide',
                        style: '',
                        'ev:onclick': 'scwin.btn_hide_onclick'
                    }
                }, {
                    T: 1,
                    N: 'xf:trigger',
