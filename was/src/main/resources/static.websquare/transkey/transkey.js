...
//		    document.getElementsByTagName("head")[0].appendChild(link);
	...
	function qwertyLayout_noinline(id, parentDiv, isMultiCursor, _cssName){
		...
		if(useTalkBack) {
			...
			innerDiv1.style.cssText = "width:560px; height: 28px; margin-left:10px; margin-top:2px; position: static;";
	...
	function numberLayout_noinline(id, parentDiv, isMultiCursor, _cssName){
		...
		if(useTalkBack) {
			...
			div.style.cssText = "width:240px; height: 24px; margin-left:4px; position: static;";
