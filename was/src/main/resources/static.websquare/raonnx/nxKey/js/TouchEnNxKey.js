...
var bEnc2 = false;
var bTobe = true; // 넥사크로 이벤트 분기처리 스크립트
...
function update_callback(result) {
    ...
    {
		var bwlimInputCurrE2EStr = result.EncData;
    	var bwlimInputCurrE2EStrObj = document.getElementById(bwlimInputCurrE2EStr);
    	var bwlimInputCurrStr = result.EncData.split('E2E_')[1]; // 현재 focus 되어있는 마우스, 키보드 TAB으로 Obj 문자열 값
		var bwlimInputCurrObj = document.getElementById(bwlimInputCurrStr);
		...
		// bwlim start
    	if (bwlimInputCurrObj.value.length != bwlimInputCurrE2EStrObj.value.length / 32) {
      		bwlimInputCurrE2EStrObj.value = '';
      		//TK_Clear("", bwlimInputCurrObj.id);
    	}
    	// bwlim end
