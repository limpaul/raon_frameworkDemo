...
var KSBizConfig = {
	...
	theme : "ksbiz",	// theme
	colorTheme : "orange", //orange(default), blue, yellow, red, brown, sky, green, accessibility
	...
	version:{
		...
		exHTMLVer			:	"2.2.0.3",
		exWinVer			:	"2.2.0.3280",
		exWin64Ver			:	"2.2.0.3280",
		exWinProtocolVer	:	"1.0.1.1604",
		daemonVer			:	"1.0.2.19",
		daemon64DownURL		:	"1.0.2.19",
		macDaemonVer		:   "1.0.1.4",
		exMacVer			:	"2.2.0.3280",
		exMacProtocolVer	:	"1.0.1.1604",
		exLinuxVer			:	"2.2.0.3280",
		exLinuxProtocolVer	:	"1.0.1.1604"
	},
	module : {
		extension : {
	...
	certPwdDefaultRule : {length: 10, alphabet: true, number: true, spchar: true, badchar: true},
...
KSBizConfig.mobisignConfig = {
	...
	aclist : "56;yessignCA Class 1;1.2.410.200005.1.1.1;yessignCA Class 1;1.2.410.200005.1.1.2;yessignCA Class 1;1.2.410.200005.1.1.4;yessignCA Class 1;1.2.410.200005.1.1.5;yessignCA Class 1;1.2.410.200005.1.1.6.1;yessignCA Class 1;1.2.410.200005.1.1.6.8;yessignCA Class 2;1.2.410.200005.1.1.1;yessignCA Class 2;1.2.410.200005.1.1.2;yessignCA Class 2;1.2.410.200005.1.1.4;yessignCA Class 2;1.2.410.200005.1.1.5;yessignCA Class 2;1.2.410.200005.1.1.6.1;yessignCA Class 2;1.2.410.200005.1.1.6.8;yessignCA Class 3;1.2.410.200005.1.1.1;yessignCA Class 3;1.2.410.200005.1.1.2;yessignCA Class 3;1.2.410.200005.1.1.4;yessignCA Class 3;1.2.410.200005.1.1.5;signGATE CA4;1.2.410.200004.5.2.1.1;signGATE CA4;1.2.410.200004.5.2.1.2;signGATE CA4;1.2.410.200004.5.2.1.7.1;signGATE CA4;1.2.410.200004.5.2.1.7.2;signGATE CA5;1.2.410.200004.5.2.1.1;signGATE CA5;1.2.410.200004.5.2.1.2;signGATE CA5;1.2.410.200004.5.2.1.7.1;signGATE CA5;1.2.410.200004.5.2.1.7.2;signGATE CA6;1.2.410.200004.5.2.1.1;signGATE CA6;1.2.410.200004.5.2.1.2;signGATE CA6;1.2.410.200004.5.2.1.7.1;signGATE CA6;1.2.410.200004.5.2.1.7.2;SignKorea CA2;1.2.410.200004.5.1.1.5;SignKorea CA2;1.2.410.200004.5.1.1.7;SignKorea CA3;1.2.410.200004.5.1.1.5;SignKorea CA3;1.2.410.200004.5.1.1.7;SignKorea CA3;1.2.410.200004.5.1.1.9;SignKorea CA4;1.2.410.200004.5.1.1.5;SignKorea CA4;1.2.410.200004.5.1.1.7;SignKorea CA4;1.2.410.200004.5.1.1.9;CrossCertCA2;1.2.410.200004.5.4.1.1;CrossCertCA2;1.2.410.200004.5.4.1.2;CrossCertCA2;1.2.410.200004.5.4.1.101;CrossCertCA3;1.2.410.200004.5.4.1.1;CrossCertCA3;1.2.410.200004.5.4.1.2;CrossCertCA3;1.2.410.200004.5.4.1.101;CrossCertCA4;1.2.410.200004.5.4.1.1;CrossCertCA4;1.2.410.200004.5.4.1.2;CrossCertCA4;1.2.410.200004.5.4.1.101;TradeSignCA2;1.2.410.200012.1.1.1;TradeSignCA2;1.2.410.200012.1.1.101;TradeSignCA2;1.2.410.200012.1.1.3;TradeSignCA3;1.2.410.200012.1.1.1;TradeSignCA3;1.2.410.200012.1.1.3;TradeSignCA3;1.2.410.200012.1.1.101;TradeSignCA3;1.2.410.200012.1.1.103;TradeSignCA4;1.2.410.200012.1.1.1;TradeSignCA4;1.2.410.200012.1.1.3;TradeSignCA4;1.2.410.200012.1.1.101;TradeSignCA4;1.2.410.200012.1.1.103;",
...
// 인증서 수단 탭 메뉴 항목(PUBLIC|YESSIGN|YESSIGNCORP|YESSIGNINT)
// YESSIGN : 금융인증서(개인), YESSIGNCORP : 금융인증서(사업자), YESSIGNINT : 금융인증서(통합)
KSBizConfig.navCertTabList = "PUBLIC|YESSIGN|YESSIGNCORP|YESSIGNINT";
...
// 금융인증서 개인(finCertSrc), 사업자(corpFinCertSrc), 통합 주소(intFinCertSrc)
KSBizConfig.yessignSrc = {
	finCertSrc : "https://t-4user.yeskey.or.kr/v1/fincert.js",
	corpFinCertSrc : "https://t-4user.yeskey.or.kr/v1/fincertCorp.js",
	intFinCertSrc : "https://t-4user.yeskey.or.kr/v1/fincertInt.js"
}

// 금융인증서
KSBizConfig.yessignFinCert = {
	src : KSBizConfig.yessignSrc.finCertSrc, // script상에서 ?dt=오늘날짜 추가 필요
	orgCode : "D201000077",
	...
	mode : '', //FinCert, FinCertCorp, FinCertInt
	nonceUrl : KSBizConfig.nonceUrl	// ucpid서명 nonce
}
...
KSBizConfig.issuerCertFilter_n =
	...
	+"CN=yessignCA Class 5,OU=personal4IB,O=yessign,C=KR|"	//조합원 인증서
	;
...
KSBizConfig.issuerCertFilter_g = ""
	...
	+"CN=MPKICA001,OU=MPKI,O=Ministry of Defense,C=KR|"		//GPKI 인증서 (국방부)
	;
...
KSBizConfig.policyOidCertFilter_g = ""
	...
	+"1.2.410.300001.2.2.2|"	//공공/국방부,개인용
	;
...
try{
		...
		if(location.href.indexOf("wpki.html") > -1){
			...
			if(!TOUCHENEX_UTIL.isMobile()){
				...
				if(typeof KSBizConfig.colorTheme != "undefined"){
					...
					} else if(KSBizConfig.colorTheme == "accessibility"){
						colorCss = './css/default_accessibility.css';
					} else {
					...
					// 인증서목록 접근성 적용
					if(KSBizConfig.selectCertBorder){
						var styleElement = document.createElement("style");
						styleElement.textContent = ".w2ui-grid .w2ui-grid-body .w2ui-grid-records table tr.w2ui-selected { border: 1px solid #000000; border-right-width: 5px; }";
	...
	console.log("[ksbiz] parent config set error ", e);
}
...
//ASN1 Encode Functions
function getHexEncoded(buffer) {
  ...
  function encodeUTF8String(string) {
	var utf8Bytes = stringToUtf8Bytes(string);
	return concatArrays(new Uint8Array([0x0C]), encodeLength(utf8Bytes.length), utf8Bytes);
  }
  ...
  function encodeLength(length) {
	if (length < 128) {
	  ...
	  var lengthBytes = encodeLengthBytes(length);
	  return concatArrays(new Uint8Array([0x80 | lengthBytes.length]), lengthBytes);
	}
  }
...
function concatArrays() {
  ...
  var totalLength = arrays.reduce(function(acc, arr) {
...
function encodeUTCTime(timeString) {
	var utcTimeStr = '';
  
	if (/^\d{12}$/.test(timeString)) {
	  utcTimeStr = timeString + 'Z';
	} else if (/^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}$/.test(timeString)) {
	  var date = new Date(timeString + " UTC");
  
	  var yy = String(date.getUTCFullYear()).slice(2);
	  ...
	  //utcTimeStr = `${yy}${MM}${DD}${hh}${mm}${ss}Z`;
	  utcTimeStr = yy + MM + DD + hh + mm + ss + "Z";
	  ...
	  throw new Error("Invalid time format. Use 'YYMMDDHHMMSS' or 'YYYY-MM-DD HH:MM:SS'.");
	}
  
	var utcTimeBytes = stringToUtf8Bytes(utcTimeStr);
	return concatArrays(new Uint8Array([0x17]), encodeLength(utcTimeBytes.length), utcTimeBytes);
  }
    ...
    function stringToUtf8Bytes(str) {
	  ...
	  for (var i = 0; i < str.length; i++) {
		...
		if (charCode < 0x80) {
		  ...
		  var surrogatePair = 0x10000 + (((charCode & 0x3ff) << 10) | (str.charCodeAt(i) & 0x3ff));
